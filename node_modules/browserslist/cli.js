...
import browserslist, { coverage as _coverage } from './'
...
if (isArg('--help') || isArg('-h')) {
  ...
  process.stdout.write('browserslist ' + version + '\n')
  ...
  if (mode === 'browsers') {
    ...
    coverage = areas.map(function (area) {
      ...
      if (area !== 'global') {
        ...
        stats = JSON.parse(readFileSync(opts.stats))
      }
      var result = _coverage(browsers, stats)
